...
def index():
    ...
    return render_template('index.html', title="Student Enrollment", classes=classes, students=students)
...
def updatestudent(id):
    ...
    # Else if the request method is a GET
        ...
        form.course.data = name.course
        form.fk_classid.data = name.fk_classid
    # If we go to the url return the template updatestudent.html
